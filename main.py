...
PAIRS = [
    "CHZUSDT","ENJUSDT","ONEUSDT", "ARUSDT","MINAUSDT","MASKUSDT","SKLUSDT","CKBUSDT","RSRUSDT","BANDUSDT",
    "ASTRUSDT","FIDAUSDT","FUNUSDT","PROMUSDT","IMXUSDT","HIFIUSDT","PHAUSDT","RLCUSDT","1INCHUSDT","MOVRUSDT",
